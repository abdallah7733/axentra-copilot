...
export const transcript: TranscriptTurn[] = [
  ...
  { step: "incoming_call", speaker: "agent", time: "00:01", text: "Thank you for calling AtlasOne Communications, this is Maya. How can I help you today?" },
  ...
  { step: "verification_started", speaker: "agent", time: "00:16", text: "I'm sorry about that, let me look into it. First I need to verify the account. Can you confirm the email address on file?" },
  { step: "email_verified", speaker: "customer", time: "00:25", text: "It's d.carter at example-mail dot com." },
  { step: "email_verified", speaker: "agent", time: "00:29", text: "Thank you. And the last four digits of the card used for payment?" },
  { step: "customer_verified", speaker: "customer", time: "00:34", text: "4471." },
  { step: "account_retrieved", speaker: "system", time: "00:36", text: "Identity verified. Account context unlocked." },
  { step: "transactions_loaded", speaker: "agent", time: "00:38", text: "You're verified, Daniel. I have your account open. Let me pull up the recent payments." },
  { step: "duplicate_detected", speaker: "system", time: "00:44", text: "Copilot flagged TX98352 as a duplicate of TX98341." },
  { step: "refund_recommended", speaker: "agent", time: "00:46", text: "I can see two charges of $49, about a minute and a half apart, on September 14. The second one is a duplicate." },
  { step: "refund_prepared", speaker: "agent", time: "00:55", text: "I can refund the duplicate to your Visa right now. It usually shows up within 3 to 5 business days." },
  { step: "awaiting_human_approval", speaker: "customer", time: "01:03", text: "That would be great, thank you." },
  { step: "refund_approved", speaker: "system", time: "01:08", text: "Refund of $49.00 approved by Maya Hassan (AG-1187). Reference RF-2026-091403-01." },
  { step: "documentation_generated", speaker: "agent", time: "01:10", text: "Done. The $49 refund is processed. You'll get an email confirmation in a few minutes." },
  { step: "resolved", speaker: "customer", time: "01:17", text: "Perfect. Thanks, Maya." },
  { step: "resolved", speaker: "agent", time: "01:19", text: "You're welcome. Is there anything else I can help with today?" },
];
